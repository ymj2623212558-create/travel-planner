...
export const COUNTRY_PREP: Record<string, TravelPrep> = {
  ...
  '奥地利': {
    documents: '护照（有效期 6 个月以上）',
    visa: '申根签证（中国护照需办理，15 天单次）',
    currency: '欧元（EUR）；刷卡普及，现金少量',
    plug: 'C/F 型两脚圆插，电压 230V',
    comm: '机场买 A1/Telekom 卡或 eSIM',
    health: '无需疫苗；药店很多（Apotheke）',
    weather: '5-9 月最佳；冬季滑雪季 12-3 月',
    tips: ['维也纳公共交通四通八达', '咖啡馆文化必体验', '萨尔茨堡/哈尔施塔特一日游'],
  },
  '匈牙利': {
    documents: '护照（有效期 6 个月以上）',
    visa: '申根签证（中国护照需办理）',
    currency: '福林（HUF）；刷卡普及',
    plug: 'C/F 型两脚圆插，电压 230V',
    comm: '机场买 Vodafone 卡或 eSIM',
    health: '无需疫苗；温泉城市',
    weather: '4-10 月最佳；夏季多瑙河游船',
    tips: ['塞切尼温泉必泡', '多瑙河夜景游船', '中央市场淘纪念品'],
  },
  '捷克': {
    documents: '护照（有效期 6 个月以上）',
    visa: '申根签证（中国护照需办理）',
    currency: '捷克克朗（CZK）；刷卡普及，现金少量',
    plug: 'C/E 型两脚圆插，电压 230V',
    comm: '机场买 O2/Vodafone 卡',
    health: '无需疫苗',
    weather: '5-9 月最佳；圣诞集市 12 月',
    tips: ['布拉格老城广场', '查理大桥日出', '啤酒比水便宜'],
  },
  '波兰': {
    documents: '护照（有效期 6 个月以上）',
    visa: '申根签证（中国护照需办理）',
    currency: '兹罗提（PLN）；刷卡普及',
    plug: 'C/E 型两脚圆插，电压 230V',
    comm: '机场买 Play/Orange 卡',
    health: '无需疫苗',
    weather: '5-9 月最佳；克拉科夫圣诞集市',
    tips: ['克拉科夫老城 UNESCO', '奥斯维辛集中营预约', '华沙老城重建故事'],
  },
  '瑞典': {
    documents: '护照（有效期 6 个月以上）',
    visa: '申根签证（中国护照需办理）',
    currency: '瑞典克朗（SEK）；几乎全刷卡，现金很少用',
    plug: 'C/F 型两脚圆插，电压 230V',
    comm: '机场买 Tele2/Telia 卡',
    health: '无需疫苗',
    weather: '5-9 月最佳；冬看极光（基律纳）',
    tips: ['斯德哥尔摩地铁站艺术', 'Fika 咖啡文化', '极光季节 9-3 月'],
  },
  '挪威': {
    documents: '护照（有效期 6 个月以上）',
    visa: '申根签证（中国护照需办理）',
    currency: '挪威克朗（NOK）；刷卡普及',
    plug: 'C/F 型两脚圆插，电压 230V',
    comm: '机场买 Telenor 卡',
    health: '无需疫苗',
    weather: '6-8 月峡湾游最佳；冬看极光（特罗姆瑟）',
    tips: ['峡湾游船（盖朗厄尔）', '物价高，做好预算', '极光季 9-3 月'],
  },
  '丹麦': {
    documents: '护照（有效期 6 个月以上）',
    visa: '申根签证（中国护照需办理）',
    currency: '丹麦克朗（DKK）；刷卡普及',
    plug: 'C/K 型两脚圆插，电压 230V',
    comm: '机场买 TDC 卡',
    health: '无需疫苗',
    weather: '5-9 月最佳',
    tips: ['新港彩色房子', '小美人鱼雕塑', '自行车王国，骑行游览'],
  },
  '芬兰': {
    documents: '护照（有效期 6 个月以上）',
    visa: '申根签证（中国护照需办理）',
    ...
    comm: '机场买 Elisa 卡',
    health: '无需疫苗',
    weather: '6-8 月最佳；冬看极光+圣诞老人村（罗瓦涅米）',
    tips: ['圣诞老人村必去', '极光季 9-3 月', '桑拿文化体验'],
  },
  '冰岛': {
    documents: '护照（有效期 6 个月以上）',
    visa: '申根签证（中国护照需办理）',
    currency: '冰岛克朗（ISK）；刷卡普及',
    plug: 'C/F 型两脚圆插，电压 230V',
    comm: '机场买 Síminn 卡',
    health: '无需疫苗；天气多变备防水衣',
    weather: '6-8 月极昼；冬看极光，环岛自驾最火',
    tips: ['黄金圈一日游', '蓝湖温泉提前订', '自驾注意路况和天气'],
  },
  '爱尔兰': {
    documents: '护照（有效期 6 个月以上）',
    visa: '爱尔兰签证（中国护照需办理，不属申根）',
    currency: '欧元（EUR）；刷卡普及',
    plug: 'G 型三脚扁插，电压 230V',
    comm: '机场买 Three/Vodafone 卡',
    health: '无需疫苗',
    weather: '5-9 月最佳；天气多变',
    tips: ['都柏林酒吧文化', '莫赫悬崖必去', '健力士酒厂参观'],
  },
  '比利时': {
    documents: '护照（有效期 6 个月以上）',
    visa: '申根签证（中国护照需办理）',
    ...
    health: '无需疫苗',
    weather: '4-9 月最佳',
    tips: ['布鲁日运河游', '巧克力/华夫饼/啤酒三宝', '布鲁塞尔大广场'],
  },
  '克罗地亚': {
    documents: '护照（有效期 6 个月以上）',
    visa: '申根签证（中国护照需办理）',
    ...
    comm: '机场买 A1/HT 卡',
    health: '无需疫苗',
    weather: '5-9 月最佳（亚得里亚海）',
    tips: ['杜布罗夫尼克权游取景地', '十六湖国家公园', '赫瓦尔岛度假'],
  },
  '墨西哥': {
    documents: '护照（有效期 6 个月以上）',
    visa: '持美国/申根/日签可免签；否则需办墨西哥签证',
    currency: '墨西哥比索（MXN）；现金+刷卡',
    plug: 'A/B 型两脚扁插，电压 127V',
    comm: '机场买 Telcel 卡（信号最好）',
    health: '建议疫苗（甲肝/伤寒）；只喝瓶装水',
    weather: '11-4 月旱季最佳；坎昆 12-4 月',
    tips: ['奇琴伊察金字塔', '坎昆/图卢姆海滩', '龙舌兰和塔可必试'],
  },
  '巴西': {
    documents: '护照（有效期 6 个月以上）',
    visa: '中国护照免签！停留 30 天',
    currency: '雷亚尔（BRL）；现金+刷卡',
    plug: 'C/N 型两脚圆插（巴西特有），电压 127V',
    comm: '机场买 Vivo/Claro 卡',
    health: '建议疫苗（黄热病区）；防蚊',
    weather: '12-3 月夏季最佳；里约狂欢节 2 月',
    tips: ['基督像/面包山', '伊瓜苏瀑布', '注意安全，避免贫民区'],
  },
  '阿根廷': {
    documents: '护照（有效期 6 个月以上）',
    visa: '中国护照免签！停留 90 天',
    currency: '阿根廷比索（ARS）；汇率波动大，多换现金',
    plug: 'C/I 型两脚圆插，电压 220V',
    comm: '机场买 Claro/Movistar 卡',
    health: '无需疫苗',
    weather: '12-2 月夏季；乌斯怀亚 11-3 月',
    tips: ['布宜诺斯艾利斯探戈', '冰川国家公园', '乌斯怀亚（世界尽头）'],
  },
  '秘鲁': {
    documents: '护照（有效期 6 个月以上）',
    visa: '中国护照免签！停留 180 天',
    currency: '索尔（PEN）；现金+刷卡',
    plug: 'A/C 型两脚扁插，电压 220V',
    comm: '机场买 Claro/Entel 卡',
    health: '马丘比丘需防高反（古柯茶）；只喝瓶装水',
    weather: '5-9 月旱季最佳（马丘比丘）',
    tips: ['马丘比丘门票提前 1-2 月订', '库斯科适应高反', '利马美食之都'],
  },
  '南非': {
    documents: '护照（有效期 6 个月以上，含 2 个空白页）',
    visa: '中国护照需办理签证（约 3-5 个工作日）',
    currency: '兰特（ZAR）；现金+刷卡',
    plug: 'D/M/N 型三脚圆插，电压 230V',
    comm: '机场买 Vodacom/MTN 卡',
    health: '建议疫苗；疟疾区（克鲁格）需防蚊药',
    weather: '11-3 月最佳；开普敦全年宜人',
    tips: ['桌山缆车', '克鲁格看五大兽', '花园大道自驾'],
  },
  '摩洛哥': {
    documents: '护照（有效期 6 个月以上）',
    visa: '中国护照免签！停留 90 天',
    currency: '迪拉姆（MAD）；现金为主',
    plug: 'C/E 型两脚圆插，电压 220V',
    comm: '机场买 Maroc Telecom 卡',
    health: '建议疫苗（甲肝）；只喝瓶装水',
    weather: '3-5 月、9-11 月最佳；撒哈拉露营 10-4 月',
    tips: ['马拉喀什麦地那', '撒哈拉沙漠露营', '菲斯皮革染坊'],
  },
  '肯尼亚': {
    documents: '护照（有效期 6 个月以上）',
    visa: '电子签（E-visa，出发前申请）',
    currency: '先令（KES）；现金为主',
    plug: 'G 型三脚扁插，电压 240V',
    comm: '机场买 Safaricom 卡（信号最好）',
    health: '黄热病疫苗必打（入境查证书）；疟疾药',
    weather: '6-10 月旱季（动物大迁徙 7-9 月）',
    tips: ['马赛马拉看大迁徙', '内罗毕长颈鹿中心', '乞力马扎罗远眺'],
  },
  '斯里兰卡': {
    documents: '护照（有效期 6 个月以上）',
    visa: '电子签（ETA，出发前申请）',
    currency: '卢比（LKR）；现金+刷卡',
    plug: 'D/G 型三脚圆插，电压 230V',
    comm: '机场买 Dialog 卡（信号最好）',
    health: '建议疫苗；防蚊',
    weather: '西南季风 5-9 月，东岸 11-4 月最佳',
    tips: ['高山茶园火车', '大象孤儿院', '狮子岩日落'],
  },
  '尼泊尔': {
    documents: '护照（有效期 6 个月以上）',
    visa: '落地签（免费 15/30/90 天）',
    currency: '卢比（NPR）；现金为主',
    plug: 'C/D 型两脚圆插，电压 230V',
    comm: '机场买 Ncell 卡',
    health: '建议疫苗；防高反（博卡拉徒步）',
    weather: '10-11 月、3-4 月最佳（能见度最高）',
    tips: ['加德满都杜巴广场', '博卡拉滑翔伞', '喜马拉雅徒步'],
  },
  '迪拜': {
    documents: '护照（有效期 6 个月以上）',
    visa: '中国护照免签！停留 30 天',
    ...
    comm: '机场买 du/Etisalat 卡',
    health: '无需疫苗；夏季 45°C+',
    weather: '11-3 月最佳；夏季极热',
    tips: ['哈利法塔提前订票', '沙漠冲沙', 'Dubai Mall 喷泉'],
  },
  '卡塔尔': {
    documents: '护照（有效期 6 个月以上）',
    visa: '中国护照免签！停留 30 天',
    currency: '里亚尔（QAR）；刷卡普及',
    plug: 'G 型三脚扁插，电压 240V',
    comm: '机场买 Ooredoo/Vodafone 卡',
    health: '无需疫苗',
    weather: '11-3 月最佳；夏季极热',
    tips: ['伊斯兰艺术博物馆', '瓦其夫集市', '沙漠内海之旅'],
  },
  '以色列': {
    documents: '护照（有效期 6 个月以上）',
    visa: '中国护照免签！停留 90 天',
    currency: '谢克尔（ILS）；刷卡普及',
    plug: 'C/H 型三脚圆插，电压 230V',
    comm: '机场买 Pelephone 卡',
    health: '无需疫苗',
    weather: '3-5 月、9-11 月最佳',
    tips: ['耶路撒冷老城', '死海漂浮', '特拉维夫海滩'],
  },
  '约旦': {
    documents: '护照（有效期 6 个月以上）',
    visa: '落地签（约旦通 Jordan Pass 免签费）',
    currency: '第纳尔（JOD）；现金+刷卡',
    plug: 'C/D/G 型，电压 230V',
    comm: '机场买 Zain/Orange 卡',
    health: '无需疫苗；只喝瓶装水',
    weather: '3-5 月、9-11 月最佳',
    tips: ['佩特拉古城（约旦通含）', '死海漂浮', '瓦迪拉姆沙漠'],
  },
};
